...
from engine import evaluate, train_one_epoch,sgg_evaluate
...
def get_args_parser():
    ...
    parser.add_argument('--file_path', default='DS/vg/', type=str)
    ...
    parser.add_argument('--resume', default='/home/enshinele/detr/MODEL_WEIGHTS/checkpoint_42.pth', help='resume from checkpoint')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_stats = sgg_evaluate(
            model, criterion, postprocessors,data_loader_val, optimizer, device, epoch,
            args.clip_max_norm)
